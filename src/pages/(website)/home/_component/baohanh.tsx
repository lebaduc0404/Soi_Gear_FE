        ...
        <div className="space-y-6">
          ...
          <ol className="list-decimal list-inside space-y-4">
            ...
            <li className="flex items-start space-x-2">
              ...
              <span>
                ...
                <br />
                <strong>Địa chỉ:</strong> Số 1 Đường Trịnh Văn Bô, Nam Từ Liêm,
                Hà Nội
              </span>
            </li>
            <li className="flex items-start space-x-2">
          ...
          <ul className="list-disc list-inside space-y-4">
            <li>
              ...
              hiện tượng bị tháo rời để tự ý can thiệp vào kết cấu bên trong của
              sản phẩm.
            </li>
            <li>
              <FaTimesCircle className="inline text-red-500 w-5 h-5 mr-2" />
              Sử dụng nguồn sạc điện trực tiếp đối với các thiết bị không dây,
              dẫn tới hỏng hóc linh kiện và chức năng sử dụng pin của bàn phím.
            </li>
            <li>
              <FaTimesCircle className="inline text-red-500 w-5 h-5 mr-2" />
          ...
          <ul className="list-disc list-inside space-y-4">
            <li>
              ...
              sản xuất mà không phải do người dùng: Hỏng mạch, chết led, lỗi kết
              nối.
            </li>
            <li>
