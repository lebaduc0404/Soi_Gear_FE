...
const ContactButtons = () => {
  return (
    <div className="relative overflow-hidden z-[999]">
      <div className="fixed bottom-10 right-[6px] p-[17px] space-y-[30px]">
        <a
          href="tel:0383005327"
          className="relative rounded-[10px] w-[45px] h-[38px] bg-red-500 flex justify-center items-center transition-transform duration-300 transform hover:scale-110 hover:animate-shake"
        >
