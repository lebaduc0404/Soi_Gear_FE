...
var versionSelector = (clerkJSVersion) => {
  ...
  const prereleaseTag = getPrereleaseTag("4.32.3");
  if (prereleaseTag) {
...
var _IsomorphicClerk = class _IsomorphicClerk2 {
  ...
  async loadClerkJS() {
    ...
    try {
      ...
      global.Clerk.sdkMetadata = (_a = this.options.sdkMetadata) != null ? _a : { name: "@clerk/clerk-react", version: "4.32.3" };
