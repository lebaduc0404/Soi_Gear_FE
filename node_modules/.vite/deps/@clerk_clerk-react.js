...
var versionSelector = (clerkJSVersion) => {
  ...
  const prereleaseTag = getPrereleaseTag("4.30.10");
  if (prereleaseTag) {
  ...
  return getMajorVersion("4.30.10");
};
...
var _IsomorphicClerk = class _IsomorphicClerk2 {
  ...
  async loadClerkJS() {
    ...
    try {
      ...
      global.Clerk.sdkMetadata = (_a = this.options.sdkMetadata) != null ? _a : { name: "@clerk/clerk-react", version: "4.30.10" };
